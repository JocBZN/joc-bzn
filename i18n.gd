...
"+1 PROJECTILE EVERY 10 LEVELS": ["每 10 级 +1 投射物", "+1 PROJEKTIL ALLE 10 LEVEL", "+1 PROYECTIL CADA 10 NIVELES", "+1 СНАРЯД КАЖДЫЕ 10 УРОВНЕЙ", "+1 PROJECTILE TOUS LES 10 NIVEAUX", "10レベルごとに弾+1", "+1 POCISK CO 10 POZIOMÓW", "HER 10 SEVİYEDE +1 MERMİ"],
