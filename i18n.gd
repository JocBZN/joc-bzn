...
# --- PUȘCĂRIA (a patra dimensiune) + WARDEN, boss-ul ei — 2026-08-17 ---
"THE PRISON": ["监狱", "DAS GEFÄNGNIS", "LA PRISIÓN", "ТЮРЬМА", "LA PRISON", "監獄", "WIĘZIENIE", "HAPİSHANE"],
"Find the statue. Wake what sleeps in it.": ["找到雕像，唤醒沉睡其中之物。", "Finde die Statue. Wecke, was in ihr schläft.", "Encuentra la estatua. Despierta lo que duerme en ella.", "Найди статую. Разбуди то, что в ней спит.", "Trouve la statue. Réveille ce qui y dort.", "像を見つけ、眠るものを起こせ。", "Znajdź posąg. Obudź to, co w nim śpi.", "Heykeli bul. İçinde uyuyanı uyandır."],
"THE GATE IS SEALED": ["大门已封", "DAS TOR IST VERSIEGELT", "LA PUERTA ESTÁ SELLADA", "ВРАТА ЗАПЕЧАТАНЫ", "LA PORTE EST SCELLÉE", "門は封じられている", "BRAMA JEST ZAPIECZĘTOWANA", "KAPI MÜHÜRLÜ"],
"Something in here still sleeps": ["此处仍有沉睡之物", "Hier drin schläft noch etwas", "Algo aquí dentro sigue durmiendo", "Здесь всё ещё что-то спит", "Quelque chose dort encore ici", "ここではまだ何かが眠っている", "Coś tu wciąż śpi", "Burada hâlâ bir şey uyuyor"],
"THE WARDEN STILL STANDS": ["典狱长仍未倒下", "DER WÄRTER STEHT NOCH", "EL ALCAIDE SIGUE EN PIE", "НАДЗИРАТЕЛЬ ЕЩЁ СТОИТ", "LE GARDIEN TIENT ENCORE", "看守はまだ立っている", "STRAŻNIK WCIĄŻ STOI", "GARDİYAN HÂLÂ AYAKTA"],
"The gate will not open until it falls": ["它倒下前，大门不会开启", "Das Tor öffnet sich erst, wenn er fällt", "La puerta no se abrirá hasta que caiga", "Врата не откроются, пока он не падёт", "La porte ne s’ouvrira pas avant sa chute", "倒すまで門は開かない", "Brama nie otworzy się, póki nie padnie", "O düşmeden kapı açılmaz"],
"THE WARDEN FALLS": ["典狱长倒下了", "DER WÄRTER FÄLLT", "EL ALCAIDE CAE", "НАДЗИРАТЕЛЬ ПАЛ", "LE GARDIEN TOMBE", "看守が倒れた", "STRAŻNIK PADA", "GARDİYAN DÜŞTÜ"],
"Press E at the gate to go back": ["在大门处按 E 返回", "Drücke E am Tor, um zurückzukehren", "Pulsa E en la puerta para volver", "Нажми E у врат, чтобы вернуться", "Appuie sur E à la porte pour revenir", "門でEを押して戻る", "Naciśnij E przy bramie, by wrócić", "Dönmek için kapıda E’ye bas"],
"Nothing is left to open": ["再无可开之门", "Es gibt nichts mehr zu öffnen", "No queda nada por abrir", "Больше нечего открывать", "Il ne reste plus rien à ouvrir", "もう開くものはない", "Nie ma już nic do otwarcia", "Açılacak bir şey kalmadı"],
"PRISON SWARM": ["监狱狂潮", "GEFÄNGNIS-SCHWARM", "ENJAMBRE DE LA PRISIÓN", "ТЮРЕМНЫЙ РОЙ", "NUÉE DE LA PRISON", "監獄スウォーム", "WIĘZIENNY RÓJ", "HAPİSHANE AKINI"],
"The gate still works. For now.": ["大门仍可通行。暂时。", "Das Tor geht noch. Vorerst.", "La puerta aún funciona. Por ahora.", "Врата ещё работают. Пока что.", "La porte marche encore. Pour l’instant.", "門はまだ使える。今のところは。", "Brama wciąż działa. Na razie.", "Kapı hâlâ çalışıyor. Şimdilik."],
"THE WARDEN": ["典狱长", "DER WÄRTER", "EL ALCAIDE", "НАДЗИРАТЕЛЬ", "LE GARDIEN", "看守", "STRAŻNIK", "GARDİYAN"],
"The statue is moving": ["雕像动了", "Die Statue bewegt sich", "La estatua se mueve", "Статуя шевелится", "La statue bouge", "像が動いている", "Posąg się rusza", "Heykel kımıldıyor"],
"THE WARDEN AWAKES": ["典狱长苏醒", "DER WÄRTER ERWACHT", "EL ALCAIDE DESPIERTA", "НАДЗИРАТЕЛЬ ПРОБУЖДАЕТСЯ", "LE GARDIEN S’ÉVEILLE", "看守が目覚める", "STRAŻNIK SIĘ BUDZI", "GARDİYAN UYANIYOR"],
"The chains are off": ["锁链已断", "Die Ketten sind ab", "Las cadenas se han soltado", "Цепи сброшены", "Les chaînes sont tombées", "鎖が外れた", "Łańcuchy opadły", "Zincirler çözüldü"],
"THE WARDEN RAGES": ["典狱长暴怒", "DER WÄRTER TOBT", "EL ALCAIDE SE ENFURECE", "НАДЗИРАТЕЛЬ В ЯРОСТИ", "LE GARDIEN ENRAGE", "看守が荒れ狂う", "STRAŻNIK WPADA W SZAŁ", "GARDİYAN ÖFKELENİYOR"],
"The ceiling starts falling": ["天花板开始塌落", "Die Decke beginnt zu fallen", "El techo empieza a caer", "Потолок начинает падать", "Le plafond commence à tomber", "天井が落ち始める", "Sufit zaczyna spadać", "Tavan çökmeye başlıyor"],
"THE WARDEN BURNS": ["典狱长燃烧", "DER WÄRTER BRENNT", "EL ALCAIDE ARDE", "НАДЗИРАТЕЛЬ ГОРИТ", "LE GARDIEN BRÛLE", "看守が燃える", "STRAŻNIK PŁONIE", "GARDİYAN YANIYOR"],
"Get off the line": ["离开射线", "Geh aus der Linie", "Sal de la línea", "Уйди с линии", "Sors de la ligne", "直線から離れろ", "Zejdź z linii", "Hattan çekil"],
"Enter the Prison": ["进入监狱", "Gefängnis betreten", "Entrar en la prisión", "Войти в тюрьму", "Entrer dans la prison", "監獄に入る", "Wejdź do więzienia", "Hapishaneye gir"],
"Leave the Prison": ["离开监狱", "Gefängnis verlassen", "Salir de la prisión", "Покинуть тюрьму", "Quitter la prison", "監獄から出る", "Opuść więzienie", "Hapishaneden çık"],
